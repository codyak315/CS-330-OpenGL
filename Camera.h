...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, float deltaTime)
    {
        ...
        if (direction == RIGHT)
            Position += Right * velocity;
        if (direction == DOWN)
            Position -= WorldUp * velocity; // WorldUp serves as the down direction
        if (direction == UP)
    ...
    /*
    * Adjusted original method that controlled zoom for camera movement speed. Processes input received from a mouse scroll-wheel event.
    */
